...
df = pd.read_csv('/root/DockerLearning/prj-docfile-SmartCar/CarDrivingIncidentInfo.csv')
...
model.save('/root/DockerLearning/prj-docfile-SmartCar/smartcar_dnn_model.h5')
